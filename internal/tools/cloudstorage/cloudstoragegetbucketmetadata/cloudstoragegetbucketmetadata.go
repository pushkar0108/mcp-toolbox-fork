...
package cloudstoragegetbucketmetadata
...
const resourceType string = "cloud-storage-get-bucket-metadata"
...
type compatibleSource interface {
	GetBucketMetadata(ctx context.Context, bucket string) (*storage.BucketAttrs, error)
}
