...
package cloudstoragedeleteobject
...
const resourceType string = "cloud-storage-delete-object"
...
type compatibleSource interface {
	DeleteObject(ctx context.Context, bucket, object string) (map[string]any, error)
}
...
func (t Tool) Invoke(ctx context.Context, primitiveMgr tools.SourceProvider, params parameters.ParamValues, accessToken tools.AccessToken) (any, util.ToolboxError) {
	...
	resp, err := source.DeleteObject(ctx, bucket, object)
	if err != nil {
