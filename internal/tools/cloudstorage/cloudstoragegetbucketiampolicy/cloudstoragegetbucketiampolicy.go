...
package cloudstoragegetbucketiampolicy
...
const resourceType string = "cloud-storage-get-bucket-iam-policy"
...
type compatibleSource interface {
	GetBucketIAMPolicy(ctx context.Context, bucket string) (map[string]any, error)
}
