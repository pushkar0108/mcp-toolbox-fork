...
package lookercreateviewfromtable_test
...
import (
	...
	lkr "github.com/googleapis/mcp-toolbox/internal/tools/looker/lookercreateviewfromtable"
)

func TestParseFromYamlLookerCreateViewFromTable(t *testing.T) {
...
func TestFailParseFromYamlLookerCreateViewFromTable(t *testing.T) {
	ctx, err := testutils.ContextWithNewLogger()
	if err != nil {
		t.Fatalf("unexpected error: %s", err)
	}
