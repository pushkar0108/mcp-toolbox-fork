...
import (
	...
	lkr "github.com/googleapis/mcp-toolbox/internal/tools/looker/lookergetparameters"
)
...
func TestFailParseFromYamlLookerGetParameters(t *testing.T) {
	...
	tcs := []struct {
	...
	}{
		{
            ...
            description: some description
			`,
			err: "error unmarshaling tool: unable to parse tool \"example_tool\" as type \"looker-get-parameters\": [3:1] unknown field \"method\"\n   1 | authRequired: []\n   2 | description: some description\n>  3 | method: GOT\n       ^\n   4 | name: example_tool\n   5 | source: my-instance\n   6 | type: looker-get-parameters",
		},
	}
	for _, tc := range tcs {
		t.Run(tc.desc, func(t *testing.T) {
