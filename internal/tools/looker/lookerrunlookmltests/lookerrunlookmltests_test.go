...
import (
	...
	lkr "github.com/googleapis/mcp-toolbox/internal/tools/looker/lookerrunlookmltests"
)
...
func TestFailParseFromYamlLookerRunLookmlTests(t *testing.T) {
	...
	tcs := []struct {
	...
	}{
		{
            ...
            description: some description
			`,
			err: "error unmarshaling tool: unable to parse tool \"example_tool\" as type \"looker-run-lookml-tests\": [3:1] unknown field \"method\"",
		},
	}
	for _, tc := range tcs {
		t.Run(tc.desc, func(t *testing.T) {
