...
package lookergetlookmltests_test
...
import (
	...
	lkr "github.com/googleapis/mcp-toolbox/internal/tools/looker/lookergetlookmltests"
)

func TestParseFromYamlLookerGetLookmlTests(t *testing.T) {
