...
package cloudsqladminexecutemany
...
const resourceType string = "cloud-sql-admin-execute-many"
...
func (cfg Config) Initialize(context.Context) (tools.Tool, error) {
	...
	if cfg.Description == "" {
		cfg.Description = "Executes multiple SQL statements on a Cloud SQL instance."
	}
